...
6. Be specific and actionable with security findings, providing clear context and risk assessment
...
1. MALICIOUS CODE ELEMENTS:
   ...
   - Detect hardcoded credentials, access tokens, or API keys
...
2. SENSITIVE INFORMATION EXPOSURE:
   - Detect any hardcoded secrets, passwords, keys, or tokens
