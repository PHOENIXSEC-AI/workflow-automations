...
from workflows.flows.doc_gen import run_generate_docs_old, run_generate_docs_new
from workflows.flows.private_repo_analysis import run_private_repo_analysis

from workflows.flows.repo_analysis import (
    RepoAnalysisTask,
    run_repo_analysis
)
from workflows.agents.models import AgentAnalysisResult, AgentBatchResult
from workflows.flows.extraction_strategies import security_review, add_basev2, clean_result_artifacts, merge_strategy_results

from core.config import app_config
from core.utils import LoggerFactory
from core.models import RepoAnalysisTask, RepoAnalysisResult, RepomixResultData, RepoFile
    ...
    for repo_url in github_repo_urls:
        ...
        try:
            if tool_run_result:
                ...
                # Result from additional strategies should be included here
                results_to_be_merged.append(base_result_data)
            else:
...
if __name__ == "__main__":
    import asyncio
    github_repos_to_process = [
        "https://github.com/modelcontextprotocol/servers",
        # "https://github.com/pandas-dev/pandas"
    ]
    
    repomix_config_path = "/workspaces/workflow-automation/src/tools/repomix/all_languages_repomix_config.json"
    
    asyncio.run(
        run_analyze_and_document_repos(
            github_repo_urls=github_repos_to_process,
            repomix_config_path=repomix_config_path,
            is_private=True  # Set to True to use direct tool_repomix approach
        )
    )